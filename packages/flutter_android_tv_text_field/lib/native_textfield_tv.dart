...
class _NativeTextFieldState extends State<NativeTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget child = AndroidView(
...
///
/// Bug fix (fork): renamed misspelled params [focuesedBorderColor] →
/// [focusedBorderColor] and [unFocuesedBorderColor] → [unfocusedBorderColor],
/// and wired the border color to use these params instead of the hardcoded
    ...
    return KeyboardListener(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(right: 10, child: widget.postFixWidget ?? const SizedBox()),
        ],
      ),
    );
  }
