...
### Fixed
- **macOS and Linux downloads are now published.** The 1.0.0 release only
  produced Windows and Android builds — the macOS and Linux jobs failed, so
  those downloads were missing entirely.
